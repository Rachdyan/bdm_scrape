...
with SB(uc=True,
    ...
    if 'verification' in current_url:
        ...
        print("DEBUG: Recaptcha detected")
        ...
        sb.sleep(2)
        print("DEBUG: Clicking Checkbox..")
        sb.uc_click("span[class*='recaptcha-checkbox']")

        sb.switch_to_default_content()
        print("DEBUG: Checking to Popup Captcha iframe..")
            ...
            try:
                ...
                while True:
                    ...
                    if captcha_data is None:
                        print("DEBUG: Popup Not Found. Clicking Continue...")
                    ...
                    # If the 3x3 captcha is an id, add previousID to the param
                    if params['cols'] == 3 and id:
                        params["previousID"] = id

                    print("DEBUG: Params before solving captcha:", params)

                    # Send captcha for solution
                    result = captcha_helper\
                        .solver_captcha(file=captcha_data['body'], **params)

                    if result is None:
                        print("DEBUG: Captcha solving failed or timed out. "
                    ...
                    # Check if the captcha was solved successfully
                        ...
                        print(f"DEBUG: Number list: {number_list}")
                        ...
                        if params['cols'] == 3:
                            ...
                            print(f"DEBUG: Error Detected: {errors_detected}")
                            if errors_detected:
                                continue
                        ...
                        # Processing for 4x4
                            ...
                            print("DEBUG: Clicking Verify button 4x4")
                            # page_actions.click_check_button(c_verify_button)
                            page_actions.click_check_button(c_verify_button)
                        ...
                        sb.sleep(3)
                        print("DEBUG: Checking error lastt")
                        errors_detected = (
                                sb.is_element_clickable(c_verify_button) or
                                sb.is_element_visible(c_try_again) or
                                sb.is_element_visible(c_select_more) or
                        ...
                        print("DEBUG: Clicking Continue butto inside loop...")
                        # sb.uc_click('button[id*="email-login-button"]')
                        sb.click('button[id*="email-login-button"]')
                        sb.sleep(3)
                        ...
                        current_url = sb.get_current_url()
                        if 'verification' in current_url:
                            print("DEBUG: Continue clicked but still in "
                            ...
                            if 'verification' not in current_url:
                                print("DEBUG: Successfully logged in after "
                                      "captcha")
                                break

                            continue

                        print("DEBUG: Breaking loop 2")
                ...
                print(f"DEBUG: Error in the process. "
                      f"Clicking Continue...: {e}")
                # page_actions.switch_to_default_content()
                try:
                    # sb.cdp.click('button[id*="email-login-button"]')
                    sb.uc_click('button[id*="email-login-button"]')
                except Exception as e:
                    print("DEBUG: Except Part 2,"
                          f"Switching to default content first {e}")
                    sb.switch_to_parent_frame()
                    # sb.cdp.click('button[id*="email-login-button"]')
                    sb.uc_click('button[id*="email-login-button"]')
        else:
            print("DEBUG: No Captcha Grid")
            sb.uc_click('button[id*="email-login-button"]')

    sb.sleep(3)
    print("DEBUG: Finished solving captcha")
    current_url = sb.get_current_url()
    print(f"DEBUG: current_url:{current_url}")

    if "otp" in current_url:
        print("DEBUG: Email Verification Page..")
        sb.sleep(20)
        ...
        print(f"DEBUG: Connecting to {IMAP_SERVER}...")
        ...
        print("DEBUG: Successfully connected and selected INBOX.")
                    ...
                    if "stockbit" in From:
                        ...
                        for part in msg.walk():
                            ...
                            try:
                                ...
                                print(f"DEBUG: Otp Code is: {otp_code}")
                                # breakpoint()
